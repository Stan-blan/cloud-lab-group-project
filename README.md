...
This project demonstrates our collective ability to plan, build, and ship a web application — from local development to live cloud deployment.
...
| Name | Role |
|------|------|
| **Elkanah Annang Ochinie** | Group Leader & GitHub Manager |
| **Stanley Blankson Gyimah** | Frontend Developer |
| **Trinity Ahiakpatsi** | Content Designer |
| **Daniel Yayra Cobblah** | Technical Support |
| **Richmond Tetteh** | Testing & Documentation |
...
- **GitHub Pages** — Cloud hosting and deployment
...
4. Click **Save** — the site will be live within moments.
